...
1. **Create Turso Database** (free)
   ...
   - Get your database URL and auth token from Settings > Authentication
...
|----------|-------------|---------|
| `TURSO_DATABASE_URL` | Your Turso database URL | `libsql://xxx.turso.io` |
| `TURSO_AUTH_TOKEN` | Your Turso auth token | `eyJhbGc...` |
